    ...
    public class Tests
    {
        ...
        public void Setup()
        {
            ...
            _employees = new()
            {
                ...
                new Employee(3,"Morgan","Freeman",10),
                new Employee(4,"Arcadiy","Parovozov",0.12m)
            };
        }
        ...
        [TestCase("FirtName:Gena", "LastName Bukin", "SalaryPerHour:101230,112312")]
        [TestCase("FirtName:Gena", "LastName:Bukin", "SalaryPrHour:101230,112312")]
        ...
        [TestCase("Gena", "LastName:Bukin", "SalaryPerHour:101230אפû112312")]
